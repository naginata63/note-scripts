...
"""
gen_cover_837b.py
cmd_837修正: note記事カバー画像再生成
「チャンネル開設2ヶ月」→「チャンネル開設2週間」に修正

出力: /home/murakami/multi-agent-shogun/projects/note_mcp_server/work/cover_837b.png
サイズ: 1280x670px
"""
...
OUTPUT_PATH = Path("/home/murakami/multi-agent-shogun/projects/note_mcp_server/work/cover_837b.png")
...
- Sub text: "チャンネル開設2週間の話" in smaller white text
...
- "チャンネル開設2週間" (sub text — important: 2週間 not 2ヶ月)
